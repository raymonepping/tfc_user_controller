...
locals {
  effective_assignment_mode      = var.assignment_mode != "" ? var.assignment_mode : local.profile_settings.assignment_mode
  effective_shared_project_mode  = var.shared_project_mode != "" ? var.shared_project_mode : local.profile_settings.shared_project_mode
  effective_shared_team_mode     = var.shared_team_mode != "" ? var.shared_team_mode : local.profile_settings.shared_team_mode
  effective_using_locked         = var.using_locked != local.profile_settings.using_locked ? var.using_locked : local.profile_settings.using_locked
  effective_enable_common_access = var.enable_common_access != local.profile_settings.enable_common_access ? var.enable_common_access : local.profile_settings.enable_common_access
  effective_email_source         = var.email_source != "" ? var.email_source : local.profile_settings.email_source
